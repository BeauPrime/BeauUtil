...
namespace BeauUtil
{
    ...
    /// </summary>
    public class CastableEvent<TInput0, TInput1>
    {
        private int m_Length = 0;
        private CastableAction<TInput0, TInput1>[] m_Actions;
        private int[] m_ContextIds = Array.Empty<int>();

        public CastableEvent()
        {
            m_Actions = Array.Empty<CastableAction<TInput0, TInput1>>();
        ...
        public CastableEvent(int inCapacity)
        {
            ...
            m_Actions = new CastableAction<TInput0, TInput1>[inCapacity];
        ...
        /// Registers an action.
        /// </summary>
        public void Register(Action<TInput0, TInput1> inAction, UnityEngine.Object inContext = null)
        {
            EnsureCapacity(m_Length + 1);
            m_Actions[m_Length] = CastableAction<TInput0, TInput1>.Create(inAction);
        ...
        /// Registers an action.
        /// </summary>
        public void Register(RefAction<TInput0, TInput1> inAction, UnityEngine.Object inContext = null)
        {
            EnsureCapacity(m_Length + 1);
            m_Actions[m_Length] = CastableAction<TInput0, TInput1>.Create(inAction);
            m_ContextIds[m_Length] = UnityHelper.Id(inContext ?? inAction.Target as UnityEngine.Object);
        ...
        /// Registers an action.
        /// </summary>
        public unsafe IntPtr Register(delegate*<TInput0, TInput1, void> inPointer)
        {
            EnsureCapacity(m_Length + 1);
            m_Actions[m_Length] = CastableAction<TInput0, TInput1>.Create(inPointer);
        ...
        /// Registers an action.
        /// </summary>
        public unsafe IntPtr Register(delegate*<ref TInput0, ref TInput1, void> inPointer)
        {
            EnsureCapacity(m_Length + 1);
            m_Actions[m_Length] = CastableAction<TInput0, TInput1>.Create(inPointer);
            m_ContextIds[m_Length] = 0;
        ...
        /// </summary>
        public void Deregister(Action<TInput0, TInput1> inAction)
        {
            if (inAction == null)
        ...
        /// Removes the registered action.
        /// </summary>
        public void Deregister(RefAction<TInput0, TInput1> inAction)
        {
            if (inAction == null)
                throw new ArgumentNullException("inAction");
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Invoke(TInput0 inInput0, TInput1 inInput1)
        {
            Invoke(ref inInput0, ref inInput1);
        }
        ...
        public void Invoke(ref TInput0 inInput0, ref TInput1 inInput1)
        {
            int idx = 0;
            int end = m_Length;
            while(idx < end)
            {
                m_Actions[idx++].Invoke(ref inInput0, ref inInput1);
            }
        }
